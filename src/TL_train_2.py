from util import *
from transfer_learning_model_finetune import *
...
if __name__ == '__main__':
    ...
    for corpus_name in corpus_names:
        train_feature = 'OLD_FINAL_transfer_learning_finetune'  # 2_embeddings_6_features   |   2_embeddings   |   only_elmo   |   2_emb_only_distance_fea
